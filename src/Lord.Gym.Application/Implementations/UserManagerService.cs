using Lord.Gym.Application.Interfaces.JWT;
...
namespace Lord.Gym.Application.Implementations
{
    public class UserManagerService : IUserManager
    {
        ...
        public UserManagerService(UserManager<AppUser> userManager, ApplicationDbContext context, RoleManager<IdentityRole> roleManager, IJwtFactory jwtFactory)
        {
